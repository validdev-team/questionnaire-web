...
export default function UserQuestionnaire() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-[#0F0251] py-12 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-50 mb-2">Thank You!</h2>
          <p className="text-md text-gray-50 mb-4">We've recorded your response.</p>
          <button
            onClick={() => window.location.reload()}
            className="hover:text-blue-500 text-sm text-gray-50 underline"
          >
